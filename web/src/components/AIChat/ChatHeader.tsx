    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex flex-col">
          <h1 className={cn("font-semibold text-foreground text-sm leading-tight", geekMode && "font-mono", evolutionMode && "bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent")}>
            {assistantName}
          </h1>
          {/* Status */}
          {actionDescription ? (
            ...
            >
              {(geekMode || evolutionMode) && <span className={cn("w-1.5 h-1.5 rounded-full animate-pulse", geekMode && "bg-green-500", evolutionMode && "bg-purple-500")} />}
              {actionDescription}
            </span>
          ) : (
      ...
      <div className="flex items-center gap-2">
        ...
        <EvolutionModeToggle
          enabled={evolutionMode}
          onToggle={onEvolutionModeToggle ?? (() => {})}
          variant="header"
        />

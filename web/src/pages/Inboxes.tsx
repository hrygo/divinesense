...
const Inboxes = () => {
  ...
  return (
    <div className="border border-border flex flex-col justify-start items-start rounded-lg bg-background text-foreground overflow-hidden">
        ...
        <div className="w-full px-4 py-4 border-b border-border">
          <div className="flex flex-row justify-between items-center">
            <div className="flex flex-row items-center gap-2">
              ...
              {unreadCount > 0 && (
                <span className="ml-1 px-2 py-0.5 text-xs font-medium rounded-full bg-primary text-primary-foreground">{unreadCount}</span>
              )}
            </div>
          </div>
        </div>

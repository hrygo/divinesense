...
export type Block = Message<"memos.api.v1.Block"> & {
  ...
  /**
   * @generated from field: int64 created_ts = 15;
   */
  createdTs: bigint;

  /**
   * @generated from field: int64 updated_ts = 16;
   */
  updatedTs: bigint;
};

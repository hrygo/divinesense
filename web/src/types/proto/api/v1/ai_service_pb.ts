...
export type ChatResponse = Message<"memos.api.v1.ChatResponse"> & {
   ...
   *
   * Summary statistics for the completed session
   *
   * @generated from field: memos.api.v1.SessionSummary session_summary = 9;
   */
 ...
 *
 * @generated from message memos.api.v1.SessionSummary
 */
export type SessionSummary = Message<"memos.api.v1.SessionSummary"> & {
  /**
  ...
  /**
   * Execution mode: "geek", "evolution", "normal"
   *
   * @generated from field: string mode = 17;
   */
  mode: string;
...
/**
 * Describes the message memos.api.v1.SessionSummary.

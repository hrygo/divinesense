...
type ScheduleIntentClassifier struct {
	routerService routerpkg.RouterService
}

// NewScheduleIntentClassifier creates a new ScheduleIntentClassifier.
func NewScheduleIntentClassifier(routerService routerpkg.RouterService) *ScheduleIntentClassifier {
...
// mapRouterIntent maps routing.Intent to ScheduleIntent.
func (c *ScheduleIntentClassifier) mapRouterIntent(intent routerpkg.Intent) ScheduleIntent {
	switch intent {
	case routerpkg.IntentScheduleCreate:
		return IntentSimpleCreate
	case routerpkg.IntentScheduleQuery:
		return IntentSimpleQuery
	case routerpkg.IntentScheduleUpdate:
		return IntentSimpleUpdate
	case routerpkg.IntentBatchSchedule:

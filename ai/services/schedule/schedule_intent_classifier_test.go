...
func (m *mockRouterService) SelectModel(ctx context.Context, task routerpkg.TaskType) (routerpkg.ModelConfig, error) {
	return routerpkg.ModelConfig{}, nil
}

func (m *mockRouterService) GetRouterStats(ctx context.Context, userID int32, timeRange time.Duration) (*routerpkg.RouterStats, error) {
	return &routerpkg.RouterStats{
		ByIntent:         make(map[routerpkg.Intent]int64),
...
func (m *mockRouterService) RecordFeedback(ctx context.Context, feedback *routerpkg.RouterFeedback) error {
	return nil
}
...
func TestScheduleIntentClassifier_MapRouterIntent(t *testing.T) {
	...
	tests := []struct {
		routerIntent routerpkg.Intent
		expected     ScheduleIntent
	}{
		{routerpkg.IntentScheduleCreate, IntentSimpleCreate},
		{routerpkg.IntentScheduleQuery, IntentSimpleQuery},
		{routerpkg.IntentScheduleUpdate, IntentSimpleUpdate},
		{routerpkg.IntentBatchSchedule, IntentBatchCreate},
		{routerpkg.IntentMemoSearch, IntentUnknown},
		{routerpkg.IntentUnknown, IntentUnknown},
	}
